...
fn test_q103_catchu_dynamic_condition() {
    ...
    for ability in &abilities {
        engine_rust::core::logic::interpreter::resolve_bytecode(&mut state, &db, &ability.bytecode, &mut ctx_q97);
        #[cfg(feature = "gpu")]
    ...
    for ability in &abilities {
        engine_rust::core::logic::interpreter::resolve_bytecode(&mut state, &db, &ability.bytecode, &mut ctx_q103_1);
        #[cfg(feature = "gpu")]
    ...
    for ability in &abilities {
        engine_rust::core::logic::interpreter::resolve_bytecode(&mut state, &db, &ability.bytecode, &mut ctx_q103_2);
        #[cfg(feature = "gpu")]
