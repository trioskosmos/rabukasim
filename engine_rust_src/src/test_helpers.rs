...
impl ZoneSnapshot {
    pub fn capture(p: &PlayerState, state: &GameState) -> Self {
        ...
        Self {
            ...
            play_count_this_turn: p.play_count_this_turn(),
            discarded_this_turn: p.discarded_this_turn,
            baton_touch_count: p.baton_touch_count(),
            baton_touch_limit: p.baton_touch_limit(),
