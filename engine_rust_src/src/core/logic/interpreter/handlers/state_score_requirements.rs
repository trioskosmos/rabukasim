...
pub fn handle_increase_heart_cost(
    ...
    if (s as usize) < 7 {
        ...
        if !state.ui.silent {
            ...
            if let Some(msg) = logging::get_opcode_log(O_INCREASE_HEART_COST, v, 0, s, 0) {
...
pub fn handle_set_heart_cost(
    ...
    let hr: crate::core::logic::interpreter::instruction::DecodedHeartRequirements = frame.heart_requirements();
    ...
    if v > 0 && v < 16 && (s as usize) < 7 {
        ...
        let hc: crate::core::logic::interpreter::instruction::DecodedHeartCounts = frame.heart_counts();
        ...
        for (i, &count) in counts.iter().enumerate() {
            ...
            if count > 0 {
                ...
                player.heart_req_addition_logs.push((
