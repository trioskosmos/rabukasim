// @generated by tools/codegen_abilities.py on 2026-03-19T05:15:51.413914
...
pub fn execute_hardcoded_ability(state: &mut GameState, _db: &CardDatabase, card_id: i32, ab_idx: usize, ctx: &AbilityContext) -> bool {
    ...
    match (card_id, ab_idx) {
        (9, 1) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: DISCARD_HAND(3) {FILTER="Ayumu/Kanon/Kaho"} (Optional) EFFECT: BOOST_SCORE(3) -> SELF
        ...
        (11, 0) => {
            // pseudocode: TRIGGER: ACTIVATED COST: MOVE_TO_DECK(6) (Optional) {FILTER="Umi/Yoshiko/Rina", FROM="DISCARD"} EFFECT: ACTIVATE_ENERGY(6) -> PLAYER
            state.activate_energy(p_idx, 6);
            true
        },
        (11, 1) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(6) (Optional) EFFECT: ADD_BLADES(3) -> PLAYER
        ...
        (64, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(1) (Optional) EFFECT: ADD_BLADES(2) -> SELF
            state.players[p_idx].blade_buffs[4 as usize] += 2;
            true
        },
        (67, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: DISCARD_HAND(1) (Optional) EFFECT: ADD_HEARTS(1) -> OTHER_MEMBER
            state.players[p_idx].heart_buffs[4 as usize].add_to_color(0 as usize, 1 as i32);
            true
        },
        (70, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: TAP_MEMBER(1) (Optional) -> SELF EFFECT: ADD_BLADES(1) -> PLAYER {TARGET="CENTER", FILTER="GROUP_ID=0"}
        ...
        (688, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(1) (Optional) EFFECT: ADD_HEARTS(1) {HEART_TYPE=1} -> SELF
        ...
        (695, 1) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: DISCARD_HAND(1) (Optional) EFFECT: ADD_HEARTS(1) {HEART_TYPE=0} -> MEMBER {FILTER="SAME_GROUP_AS_DISCARDED"}
            state.players[p_idx].heart_buffs[4 as usize].add_to_color(0 as usize, 1 as i32);
            true
        },
        (4791, 1) => {
        ...
        (698, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: DISCARD_HAND(2) {FILTER="SAME_GROUP"} (Optional) EFFECT: ADD_HEARTS(2) {HEART_TYPE=1, DURATION="UNTIL_LIVE_END"}
            state.players[p_idx].heart_buffs[4 as usize].add_to_color(1 as usize, 2 as i32);
            true
        },
        (4794, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: DISCARD_HAND(2) {FILTER="SAME_GROUP"} (Optional) EFFECT: ADD_HEARTS(2) {HEART_TYPE=1, DURATION="UNTIL_LIVE_END"}
        ...
        (234, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(1) (Optional) EFFECT: ADD_BLADES(1) -> PLAYER
            state.players[p_idx].blade_buffs[4 as usize] += 1;
            true
        },
        (4330, 0) => {
        ...
        (568, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(1) (Optional) EFFECT: ADD_HEARTS(1) {HEART_TYPE=2} -> SELF
            state.players[p_idx].heart_buffs[4 as usize].add_to_color(2 as usize, 1 as i32);
            true
        },
        (571, 0) => {
        ...
        (577, 0) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY {MAX=2} (Optional) EFFECT: ADD_BLADES(1) -> PLAYER {PER_ENERGY_PAID=1}
            state.players[p_idx].blade_buffs[4 as usize] += 1;
            true
        },
        (854, 2) => {
        ...
        (858, 0) => {
            // pseudocode: TRIGGER: ACTIVATED (Once per turn) COST: MOVE_TO_DISCARD(3) (Optional) {FROM="DECK_TOP"} EFFECT: ADD_BLADES(COUNT_MEMBER_LIELLA_DISCARDED) (Optional) -> SELF {DURATION="UNTIL_LIVE_END"}
            state.players[p_idx].blade_buffs[4 as usize] += 1;
            true
        },
        (4954, 0) => {
        ...
        (873, 1) => {
            // pseudocode: TRIGGER: ON_LIVE_SUCCESS COST: PAY_ENERGY(1) (Optional) EFFECT: DRAW(1) (Optional)
            state.draw_cards(p_idx, 1 as u32);
            true
        },
        (881, 0) => {
        ...
        (882, 1) => {
            // pseudocode: TRIGGER: ON_LIVE_START COST: PAY_ENERGY(1) (Optional) EFFECT: PLACE_ENERGY_WAIT(1) -> PLAYER
            state.draw_energy_cards(p_idx, 1);
            true
        },
        (4978, 0) => {
