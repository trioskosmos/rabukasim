...
pub struct GpuInteraction {
    ...
    pub _pad: [u32; 3],         // Padding for alignment to 64 bytes (16-byte alignment)
}
...
pub const GPU_GAME_STATE_SIZE: usize = 1952; // Updated: 1936 + (4 bytes/struct * 4 structs) = 1952
...
mod tests {
    ...
    fn test_layout_consistency() {
        ...
        // GpuInteraction (64 bytes)
        assert_eq!(size_of::<GpuInteraction>(), 64);
        assert_eq!(align_of::<GpuInteraction>(), 4);
