...
fn test_effects_group_ab_stats_zone() {
    ...
    state.resolve_bytecode(&db, &bc_recov, &ctx);
...
fn test_opcode_reveal_until_cost_ge() {
    ...
    db.members.insert(60010, m10.clone()); db.members_vec[60010 & LOGIC_ID_MASK as usize] = Some(m10);
    db.members.insert(60015, m15.clone()); db.members_vec[60015 & LOGIC_ID_MASK as usize] = Some(m15);
    db.members.insert(60001, m1.clone()); db.members_vec[60001 & LOGIC_ID_MASK as usize] = Some(m1);
