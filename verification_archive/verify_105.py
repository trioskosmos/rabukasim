...
print("Manually verifying ability 105...")
...
ability_105['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中から『lilywhite』のカードを1枚公開して手札に加えてもよい": "Frame 2: unit_id=LILY_WHITE, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 105 - marked as unverified due to missing discard logic")
print("Saved file")
