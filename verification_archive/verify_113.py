...
print("Manually verifying ability 113...")
...
ability_113['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中から『Aqours』のメンバーカードを1枚公開して手札に加えてもよい": "Frame 2: card_type=MEMBER, group_id=AQOURS, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 113 - marked as unverified due to missing discard logic")
print("Saved file")
