...
print("Manually verifying ability 110...")
...
ability_110['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中から『みらくらぱーく！』のカードを1枚公開して手札に加えてもよい": "Frame 2: unit_id=MIRA_CRA_PARK, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 110 - marked as unverified due to missing discard logic")
print("Saved file")
