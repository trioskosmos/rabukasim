...
print("Manually verifying ability 112...")
...
ability_112['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中からライブカードを1枚公開して手札に加えてもよい": "Frame 2: card_type=LIVE, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 112 - marked as unverified due to missing discard logic")
print("Saved file")
