...
print("Manually verifying ability 107...")
...
ability_107['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中からメンバーカードを1枚公開して手札に加えてもよい": "Frame 2: card_type=MEMBER, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 107 - marked as unverified due to missing discard logic")
print("Saved file")
