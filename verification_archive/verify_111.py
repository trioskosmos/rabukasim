...
print("Manually verifying ability 111...")
...
ability_111['frame_verification'] = {
    ...
    "text_mapping": {
        ...
        "その中からメンバーカードを1枚公開して手札に加えてもよい": "Frame 4: card_type=MEMBER, is_optional=1 (ISSUE: missing reveal=1)",
...
print("Verified ability 111 - marked as unverified due to missing discard logic")
print("Saved file")
