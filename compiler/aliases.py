...
TRIGGER_ALIASES = {
    ...
    "ON_MOVE": "ON_LEAVES",
    "ON_MOVE_TO_DISCARD": "ON_MOVE_TO_DISCARD",
...
CONDITION_ALIASES = {
    ...
    "SCORE_GT": ("SCORE_TOTAL_CHECK", {"comparison": "GT"}),
    "SCORE_LT": ("SCORE_TOTAL_CHECK", {"comparison": "LT"}),
    "SCORE_EQ": ("SCORE_TOTAL_CHECK", {"comparison": "EQ"}),
    ...
    "VALUE_LE": ("SUM_VALUE", {"comparison": "LE"}),
    "VALUE_GT": ("SUM_VALUE", {"comparison": "GT"}),
    "VALUE_LT": ("SUM_VALUE", {"comparison": "LT"}),
    "SCORE_GT_OPPONENT": ("SCORE_COMPARE", {"type": "score", "comparison": "GT", "target": "opponent"}),
