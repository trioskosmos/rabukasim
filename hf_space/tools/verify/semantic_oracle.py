            ...
            scenarios.append(
                {
                    ...
                    "expect": {"energy_paid": energy_cost, "notes": f"Must pay {energy_cost} Energy."},
                }
            )
            ...
            scenarios.append(
                {
                    ...
                    "setup": {},
                    "action": {"type": "ACTIVATE"},
                    "expect": {"member_sacrificed": True, "notes": "Must sacrifice self."},
                }
            )
                ...
                scenarios.append(
                    {
                        ...
                        "trigger": trigger,
                        "setup": {"deck_top": ["PINK_BLADE_CARD"], "description": "Top card has Pink Blade"},
                        "action": {"type": "START_LIVE"},
                        "expect": {"blade_color_delta": "BLUE", "notes": "Revealed card's blade becomes Blue."},
                    }
                )
                ...
                scenarios.append(
                    {
                        ...
                        "action": {"type": "START_LIVE"},
                        "expect": {"score_delta": 0, "notes": "Score should NOT increase."},
                    }
                )
                ...
                scenarios.append(
                    {
                        ...
                        "trigger": trigger,
                        "setup": {"deck_top": ["MEMBER_CARD"], "description": "Top of deck is a Member"},
                        "action": {"type": "LIVE_SUCCESS"},
                        "expect": {"hand_delta": 1, "notes": "Revealed member is added to hand."},
                    }
                )
                ...
                scenarios.append(
                    {
                        ...
                        "trigger": trigger,
                        "setup": {"deck_top": ["SPELL_CARD"], "description": "Top of deck is NOT a Member"},
                        "action": {"type": "LIVE_SUCCESS"},
                        "expect": {"hand_delta": 0, "notes": "Revealed spell is NOT added to hand."},
                    }
                )

    return {"card_no": card_id, "scenarios": scenarios}
