            ...
            if not is_e_card:
                ...
                if "TRIGGER: ON_" in current_p or "TRIGGER: ACTIVATED" in current_p:
                    ...
                    new_lines = [
                        l
                        for l in lines
                        if "TRIGGER: CONSTANT" in l or "EFFECT: ADD_HEARTS" in l or "EFFECT: ADD_BLADES" in l
                    ]
                ...
                new_lines = [
                    l
                    for l in lines
                    if "TRIGGER: CONSTANT" in l
                    or "EFFECT: ADD_HEARTS" in l
                    or "EFFECT: ADD_BLADES" in l
                    or "EFFECT: BOOST_SCORE" in l
                ]
                manual_data[card_id]["pseudocode"] = "\n".join(new_lines).strip()
                modified_count += 1
