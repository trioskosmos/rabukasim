    ...
    for card_no in data:
        if "bp5-004" in card_no:
            if card_no.startswith("PL!-"):
                data[card_no]["pseudocode"] = umi_logic
            elif card_no.startswith("PL!SP-"):
                data[card_no]["pseudocode"] = sumire_logic
            elif card_no.startswith("PL!N-"):
                data[card_no]["pseudocode"] = karin_logic
            elif card_no.startswith("PL!HS-"):
                data[card_no]["pseudocode"] = ginko_logic
            elif card_no.startswith("PL!S-"):
                data[card_no]["pseudocode"] = dia_logic
