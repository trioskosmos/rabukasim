...
def compare_pseudocodes():
    ...
    print("=== Pseudocode Comparison Report ===\n")
    ...
    for card_no in sorted(common_cards):
        ...
        if orig_pc != fresh_pc:
            differences.append({"card_no": card_no, "original": orig_pc, "fresh": fresh_pc})
    ...
    print("Detailed comparison written to reports/pseudocode_comparison.md")
