...
_ACTION_PATTERNS = {
    ...
    "add_to_hand_cost_until": r"控え室(?:から)?コスト\d+以下の.*(\d+)枚まで手札に加(?:え|える)",
    ...
    "tap_until": r"メンバー.*(\d+)人までウェイトに(?:する|してもよい)",
