...
def pack_a_heart_cost(
    req_1=0, req_2=0, req_3=0, req_4=0, req_5=0, req_6=0, req_7=0, req_8=0, unit_enabled=0, unit_id=0
):
    res = 0
    res |= (req_1 & 0xF) << 0
    res |= (req_2 & 0xF) << 4
