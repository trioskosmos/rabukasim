...
import engine_rust
from alphazero.alphanet import ACTION_TYPE_TABLE, ACTION_SUB_TABLE, ACTION_TYPE_RANGES, NUM_ACTION_TYPES
    ...
    for g in range(num_games):
        ...
        while not state.is_terminal() and state.turn < 50:
            ...
            for aid in legal_ids:
                ...
                if range_start == -1: continue # Should not happen
                ...
                if mapped_sub >= 100:
                    if t_idx not in violations: violations[t_idx] = set()
