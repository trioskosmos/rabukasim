...
import engine_rust
from alphazero.alphanet import ACTION_TYPE_RANGES, build_action_decomposition_table
...
def main():
    ...
    while not state.is_terminal() and state.turn < turn_limit:
        ...
        suggestions = state.get_mcts_suggestions(50, 1.41, engine_rust.SearchHorizon.GameEnd(), engine_rust.EvalMode.TerminalOnly)
