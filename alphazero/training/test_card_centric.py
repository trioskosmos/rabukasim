...
def test_model_output_shape():
    ...
    print("✓ Action space: 8 phase + 60 generic + 180 slot-specific (60×3)")
...
def test_action_mapping_functions():
    ...
    try:
        ...
        print("  - engine_action_to_action_256: 22k→256 mapping")
        print("  - action_256_to_engine_action: 256→22k mapping")
        print("  - build_action_mask_248: phase-aware masking")
...
def test_neural_mcts():
    ...
    try:
        ...
        print("✓ Action space breakdown:")
        print("    - 0: Pass")
        print("    - 1-6: Mulligan (6)")
        print("    - 7: Confirm")
        print("    - 8-67: Generic card plays (60)")
        print("    - 68-127: Play to slot 0 (60)")
        print("    - 128-187: Play to slot 1 (60)")
        print("    - 188-247: Play to slot 2 (60)")
