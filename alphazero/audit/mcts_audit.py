...
def mcts_stability_audit():
    ...
    while not state.is_terminal():
        ...
        suggestions = state.get_mcts_suggestions(16, 0.0, engine_rust.SearchHorizon.GameEnd(), engine_rust.EvalMode.Normal)
    ...
    while time.time() - start_time < 10:
        ...
        suggestions = state.get_mcts_suggestions(total_sims, 0.0, engine_rust.SearchHorizon.GameEnd(), engine_rust.EvalMode.Normal)
