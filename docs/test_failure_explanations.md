...
- The live engine uses instruction/frame decoding, but a lot of tooling, debug output, and tests still talk in bytecode terms.
...
- and some were waiting on the engine to stop pretending bytecode was still the primary model.
