#!/usr/bin/env python3
"""
Remove patterns with zero matches from extract_abilities_to_template.py - version 2
"""
...
if pattern_match:
    ...
    if unused_patterns:
        ...
        with open('c:\\Users\\trios\\.gemini\\antigravity\\vscode\\loveca-copy\\tools\\extract_abilities_to_template.py.backup_before_removal', 'w', encoding='utf-8') as f:
            f.write(content)
        ...
        print(f"Backup created: extract_abilities_to_template.py.backup_before_removal")
        print(f"Modified: extract_abilities_to_template.py")
    else:
        print("\nNo unused patterns to remove")
