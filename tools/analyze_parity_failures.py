...
def main():
    ...
    parser.add_argument('--input', '-i', default='reports/test_output.txt',
                        help='Input test output file')
    parser.add_argument('--output', '-o', default='reports/failure_analysis.md',
                        help='Output report file')
    parser.add_argument('--json', '-j', default='reports/failure_analysis.json',
