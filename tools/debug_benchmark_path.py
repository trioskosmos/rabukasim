...
def map_engine_to_vanilla(p_data, engine_id, initial_deck):
    ...
    if 20000 <= engine_id <= 20002: return 0 # RPS
    return -1
...
def run_benchmark(model_path=None):
    ...
    print(f"--- Running Debug Benchmark ---")
    ...
    for deck in all_decks:
        for seed in FIXED_SEEDS:
            ...
            print(f"DEBUG: State AFTER init - Turn: {state.turn}, Phase: {state.phase}, Terminal: {state.is_terminal()}")
