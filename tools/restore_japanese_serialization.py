...
content = content.replace('("縲宣幕蟋九€代ヱ繝輔か繝ｼ繝槭Φ繧ｹ".into(), "繝代ヵ繧ｩ繝ｼ繝槭Φ繧ｹ繧帝幕蟋九＠縺ｾ縺吶€・.into())', '("【開始】パフォーマンス".into(), "パフォーマンスを開始します。".into())')
content = content.replace('("縲仙ｮ御ｺ・€第ｬ｡縺へ".into(), "邨先棡繧堤｢ｺ隱阪＠縺ｦ谺｡縺へ騾ｲ縺ｿ縺ｾ縺吶€・.into())', '("【完了】次へ".into(), "結果を確認して次へ進みます。".into())')
content = content.replace('("縲千｢ｺ螳壹€代・繝ｪ繧ｬ繝ｳ".into(), "謇区惆繧堤｢ｺ螳壹＠縺ｦ繝槭Μ繧ｬ繝ｳ繧堤ｵゆｺ・＠縺ｾ縺吶€・.into())', '("【確定】マリガン".into(), "手札を確定してマリガンを終了します。".into())')
content = content.replace('("縲千｢ｺ螳壹€代そ繝・ヨ螳御ｺ守.into(), "繝ｩ繧､繝悶き繝ｼ繝峨・繧ｻ繝・ヨ繧堤ｵゆｺ・＠縺ｾ縺吶€・.into())', '("【確定】セット完了".into(), "ライブカードのセットを終了します。".into())')
content = content.replace('("縲舌せ繧ｭ繝・・縲代ヱ繧ｹ".into(), "菴輔ｂ縺励↑縺・€・.into())', '("【スキップ】パス".into(), "何もしない。".into())')
content = content.replace('format!("縲舌・繝ｪ繧ｬ繝ｳ縲捜}", card_name)', 'format!("【マリガン】{}", card_name)')
content = content.replace('"縺薙・繧ｫ繝ｼ繝峨ｒ繝・ャ繧ｭ縺ｫ謌ｻ縺励※蠑輔″逶ｴ縺励∪縺吶€・.into()', '"このカードをデッキに戻して引き直します。".into()')
content = content.replace('("蟾ｦ", "荳ｭ", "蜿ｳ", "逋ｻ蝣ｴ", "縺ｫ鄂ｮ縺・, "繝舌ヨ繝ｳ繧ｿ繝・メ", "騾€蝣ｴ", "謾ｯ謇・, "繧ｳ繧ｹ繝・)', '("左", "中", "右", "登場", "に置く", "バトンタッチ", "退場", "支払", "コスト")')
