...
def process_alphazero():
    ...
    if 'use crate::core::alphazero_encoding::AlphaZeroEncoding;' not in content:
        content = content.replace('use crate::core::logic::{CardDatabase, GameState};', 'use crate::core::logic::{CardDatabase, GameState};\nuse crate::core::alphazero_encoding::AlphaZeroEncoding;')
        with open(path, 'w', encoding='utf-8') as f:
            f.write(content)
            print("Fixed alphazero_evaluator.rs")

def process_handlers():
    path = r"c:\Users\trios\.gemini\antigravity\vscode\loveca-copy\engine_rust_src\src\core\logic\interpreter\handlers.rs"
    with open(path, 'r', encoding='utf-8') as f:
        content = f.read()
