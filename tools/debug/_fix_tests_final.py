...
CHOICE_VARIANTS = [
    "Optional", "PayEnergy", "RevealHand", "SelectDiscard", "SelectSwapSource",
    "SelectStage", "SelectStageEmpty", "SelectLiveSlot", "SelectSwapTarget",
    "SelectMember", "SelectDiscardPlay", "SelectHandDiscard", "ColorSelect",
    "SelectMode", "OpponentChoose", "SelectCardsOrder", "TapO", "LookAndChoose",
    "SelectCards", "SelectPlayer", "SelectLive", "OrderDeck", "SelectHandPlay",
    "TapMSelect", "MoveMemberDest", "RecovL", "RecovM"
]
...
def process_file(filepath):
    ...
    # 0. Handle Imports
    if 'ChoiceType' in content and 'use crate::core::enums::ChoiceType' not in content and 'use crate::core::logic::*' not in content:
    ...
    content = content.replace('let choice_type = &state.interaction_stack.last().unwrap().choice_type;', 
