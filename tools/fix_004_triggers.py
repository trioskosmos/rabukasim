...
def fix_bp5_004():
    ...
    variants = [
        "PL!SP-bp5-004-P", "PL!SP-bp5-004-R", "PL!SP-bp5-004-AR", "PL!SP-bp5-004-SEC", "PL!SP-bp5-004-R＋",
        "PL!-bp5-004-P", "PL!-bp5-004-R＋", "PL!-bp5-004-SEC", "PL!-bp5-004-AR",
        "PL!HS-bp5-004-AR", "PL!HS-bp5-004-P", "PL!HS-bp5-004-R",
        "PL!N-bp5-004-AR", "PL!N-bp5-004-P", "PL!N-bp5-004-R＋", "PL!N-bp5-004-SEC",
        "PL!S-bp5-004-AR", "PL!S-bp5-004-P", "PL!S-bp5-004-R＋", "PL!S-bp5-004-SEC"
    ]
    ...
    for c in none_cards:
        if c in data:
            data[c]["pseudocode"] = data[c]["pseudocode"].replace("TRIGGER: NONE", "TRIGGER: ON_LIVE_START") # Default to Live Start if missing
