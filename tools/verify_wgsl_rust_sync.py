...
def main():
    ...
    parser.add_argument("--wgsl", default="engine_rust_src/debug_concatenated_shader.wgsl",
                        help="Path to WGSL shader file")
    parser.add_argument("--rust", default="engine_rust_src/src/core/gpu_state.rs",
                        help="Path to Rust source file")
    parser.add_argument("--report", default="reports/wgsl_rust_sync_report.json",
                        help="Path to output JSON report")
    parser.add_argument("--fix", action="store_true",
                        help="Generate missing Rust structs from WGSL")
