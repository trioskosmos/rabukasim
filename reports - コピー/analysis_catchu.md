# Card Report: PL!SP-pb1-023-L

## IDs
- **Engine Packed ID**: `605`
- **Logic ID**: `605`
- **Variant Index**: `0`

## Metadata (Source: cards.json)
- **Name**: ディストーション
- **Card No**: PL!SP-pb1-023-L
- **Ability (JP)**:
```
...
自分のステージに名前の異なる『CatChu!』のメンバーが2人以上いる場合、エネルギーを6枚までアクティブにする。その後、自分のエネルギーがすべてアクティブ状態の場合、このカードのスコアを＋１する。』について。
...
- **Name (Compiled)**: ディストーション

### Ability 0
- **Trigger**: `2`
- **Bytecode**: `[203, 2, 85262337, 8388608, 52, 81, 6, 0, 0, 4, 1, 0, 0, 0, 0]`

#### Decoded Bytecode
```
  00: CHECK_COUNT_STAGE    | v(Val):2, a(Attr):36028797104226305, s(Comp):GE (>=), s(Slot):Context Area
  05: ACTIVATE_ENERGY      | v=6, a=0, s=4
...
### Ability 1
- **Trigger**: `2`
- **Bytecode**: `[29, 1, 8, 0, 4, 16, 1, 0, 0, 4, 1, 0, 0, 0, 0]`

#### Decoded Bytecode
```
  00: META_RULE            | v=1, a=8, s=4
  05: BOOST_SCORE          | v=1, a=0, s=4
  10: RETURN               | v=0, a=0, s=0
