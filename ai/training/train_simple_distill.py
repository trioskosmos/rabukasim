...
from alphazero.alphanet import ACTION_TYPE_TABLE, ACTION_SUB_TABLE
...
def train(data_path, model_path="models/fast_model_distill.pt", epochs=20, batch_size=128, lr=1e-3):
    ...
    for epoch in range(epochs):
        ...
        print(f"Epoch {epoch+1}/{epochs} | Loss: {avg_loss:.4f} | Acc Type: {avg_acc_type:.4f} | Acc Sub: {avg_acc_sub:.4f}")
